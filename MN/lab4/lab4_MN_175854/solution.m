...
ex_d();
ex_a(title_approx, title_diffs, x_label, y_label, bis_suffix, sec_suffix, file_path);
ex_b(title_approx, title_diffs, x_label, y_label, bis_suffix, sec_suffix, file_path);
ex_c(title_approx, title_diffs, x_label, y_label, bis_suffix, sec_suffix, file_path);
 



function ex_a(title_approx,title_diffs,x_label,y_label,bis_suffix,sec_suffix,file_path)
...
shortPlot(bis_x_dif, title_diffs, bis_suffix, x_label, y_label, gcf, file_path, 'a_1.png');
shortPlot(sec_x_dif, title_diffs, sec_suffix, x_label, y_label, gcf, file_path, 'a_2.png');
shortPlot(bis_fx, title_approx, bis_suffix, x_label, y_label, gcf, file_path, 'a_3.png');
shortPlot(sec_fx, title_approx, sec_suffix, x_label, y_label, gcf, file_path, 'a_4.png');


end

function ex_b (title_approx,title_diffs,x_label,y_label,bis_suffix,sec_suffix,file_path)
...
shortPlot(bis_x_dif_2, title_diffs, bis_suffix, x_label, y_label, gcf, file_path, 'b_1.png');
shortPlot(sec_x_dif_2, title_diffs, sec_suffix, x_label, y_label, gcf, file_path, 'b_2.png');
shortPlot(bis_fx_2, title_approx, bis_suffix, x_label, y_label, gcf, file_path, 'b_3.png');
shortPlot(sec_fx_2, title_approx, sec_suffix, x_label, y_label, gcf, file_path, 'b_4.png');

end

function ex_c (title_approx,title_diffs,x_label,y_label,bis_suffix,sec_suffix,file_path)
...
shortPlot(bis_x_dif_3, title_diffs, bis_suffix, x_label, y_label, gcf, file_path, 'c_1.png');
shortPlot(sec_x_dif_3, title_diffs, sec_suffix, x_label, y_label, gcf, file_path, 'c_2.png');
shortPlot(bis_fx_3, title_approx, bis_suffix, x_label, y_label, gcf, file_path, 'c_3.png');
shortPlot(sec_fx_3, title_approx, sec_suffix, x_label, y_label, gcf, file_path, 'c_4.png');
